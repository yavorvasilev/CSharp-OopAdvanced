namespace RecyclingStation.WasteDisposal
{
    ...
    public class GarbageProcessor : IGarbageProcessor
    {
        ...
        public IStrategyHolder StrategyHolder { get { return this.strategyHolder; } private set { this.strategyHolder = value; } }
        ...
        public IProcessingData ProcessWaste(IWaste garbage)
        {
            ...
            //{
                ...
                IGarbageDisposalStrategy acticatedStrategy = (IGarbageDisposalStrategy)Activator.CreateInstance(typeOfCorrespondingStrategy);

                //this.StrategyHolder.AddStrategy(typeOfAttribute, acticatedStrategy);
            //}

            //IGarbageDisposalStrategy currentStrategy = this.StrategyHolder.GetDisposalStrategies[typeOfAttribute];

            //var currentStrategy = acticatedStrategy.ProcessGarbage(garbage);

            return acticatedStrategy.ProcessGarbage(garbage);
        }
    }
}
